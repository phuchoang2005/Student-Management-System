...
1. **[01-product-backlog.md](./01-product-backlog.md)** — the ranked, estimated backlog: 7 epics, 33 items (18 user stories reused verbatim from `BA-docs/user-stories.md`, plus 6 platform-setup and 6 hardening items sourced from `Testing/02-test-plan.md`).
...
| --- | --- |
| [BA-docs/user-stories.md](../BA-docs/user-stories.md) | The 18 user stories (US-1.1–US-6.3) that make up most of the Product Backlog, reused by ID |
| [BA-docs/use-cases.md](../BA-docs/use-cases.md) | The 23 use cases (UC-1–UC-23) each backlog item traces to |
...
| [Testing/03-test-cases/](../Testing/03-test-cases/) | The 141 test cases each sprint's Definition of Done points back to |
...
| Sprint 3 | US-4.1, US-4.2, US-5.5, US-6.1, US-6.2, US-6.3, US-5.4 | UC-11, UC-12, UC-20, UC-21, UC-22, UC-23, UC-16 |
| Sprint 4 | — (cross-cutting; spans all) | RBAC/cascade/optimistic-locking/ambiguity-resolution coverage across all 23 UCs |

All 18 user stories and all 23 use cases are accounted for across Sprints 1–4; see [Testing/README.md](../Testing/README.md)'s UC → File Index for the corresponding test-case mapping.
