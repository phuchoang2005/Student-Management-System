...
| --- | --- |
| [req.md](../BA-docs/req.md) | Business rule IDs (Student.1–4, Book.1–5, Course.1–3, Enrollment.1–4, Identity.1–5) that every test case's "Related UC / Rule" field traces back to |
| [use-cases.md](../BA-docs/use-cases.md) | The 23 use cases (UC-1–UC-23) that structure every test-case file below |
...
| RBAC matrix, must-change-password gate, optimistic locking, cross-module cascades, error envelope, architecture conformance (ArchUnit) | [cross-cutting.md](./03-test-cases/cross-cutting.md) |
