...
- Why each hazard matters, the SLO classes, and the run evidence each hypothesis above is measured against — see the v0.0 benchmark documents, especially [`01-benchmark-strategy.md`](./benchmark-strategy/01-benchmark-strategy.md), [`05-baseline-and-reporting.md`](./benchmark-strategy/05-baseline-and-reporting.md), and [`06-conclusions-and-recommendations.md`](./06-conclusions-and-recommendations.md).
