 ...
 * String, int)} so consuming modules (e.g. {@code me}) can embed a book's summary fields without
 * depending on {@code book}'s internal layers, mirroring {@code course.CourseSummary}/{@code
 * student.StudentSummary} (06-low-level-design.md §4.8). Placed at the module root, not {@code
 * domain/}, for the same "published language" reason as {@link BookId}.
 *
