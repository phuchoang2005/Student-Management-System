 ...
 * Student-scoped, independently-paginated view of ownership for {@code GET
 * /api/v1/me/books-and-courses} (US-5.4).
 */
public interface BookLookup {

  /** Consumed by {@code MeController} (US-5.4) to embed the caller's own owned books, one page at a time. */
