 ...
 * far — needs a Student-scoped, independently-paginated view for {@code GET
 * /api/v1/me/books-and-courses} (US-5.4). Returns {@link CourseSummary} directly, not a bespoke
...
public interface EnrollmentLookup {
  ...
  /** Consumed by {@code MeController} (US-5.4) to embed the caller's own enrolled courses, one page at a time. */
